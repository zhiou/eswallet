    ...
    public:
        ...
        bytestream send(const bytestream& apdu) {
            ...
            else if (apdu.startWith("8033000043b44101")) // 首次认证
            {
                ...
                auto encrypted_data = sm2::encrypt(rand + spkey + sid + compare_number, pubkey);
            ...
            else if (apdu.startWith("803300002FB52D")) //认证
            {
                ...
                if (random == rand) return bytestream("6D00");
            ...
            {
                repo = bytestream( "0101020304050607080102030405060708010203040506070801020304050607080102030405060708010203040506070801020304050607080102030405060708");
            }
